    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tfoot>
            ...
            <!-- <form action="/session" method="POST">
                <a href="{{ url('/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continuare Cumparaturi</a></td>
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <button class="btn btn-success" type="submit" id="checkout-live-button"><i class="fa fa-money"></i> Checkout</button>
                </form> -->
                <!--payments
                <td><a href="{{ url('/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continuare Cumparaturi</a></td>
                <td><a href="{{ url('/') }}" class="btn btn-success"><i class="fa fa-angle-left"></i> Plata</a></td>
                <button class="btn btn-success" type="submit" id="checkout-live-button"><i class="fa fa-angle-left"></i> Checkout</button>
                <td colspan="2" class="hidden-xs"></td>
